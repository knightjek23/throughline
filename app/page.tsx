...
function PricingCard({
  ...
  return (
    ...
    >
      ...
      <Link
        href="/sign-up"
        className={`t-body-m mt-8 inline-flex w-full items-center justify-center rounded-md px-5 py-3 transition-colors duration-[var(--ku-dur-hover)] ${
          emphasized
    ...
    <main className="pb-24">
      ...
      <section className="mx-auto max-w-3xl px-6 pt-24 pb-20 sm:pt-32">
        ...
        <div className="mt-10 flex flex-wrap items-center gap-4">
          <Link
            href="/sign-up"
            className="t-body-m cta-hover rounded-md bg-[var(--color-accent)] px-5 py-3 text-[var(--color-bg-base)] transition-colors duration-[var(--ku-dur-hover)] hover:bg-[var(--color-accent-hover)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]"
          >
            Start 21-day trial
          </Link>
          <Link
      ...
      <section className="mx-auto max-w-3xl px-6 py-24 text-center">
        ...
        <div className="mt-10">
          <Link
            href="/sign-up"
            className="t-body-m cta-hover inline-flex items-center rounded-md bg-[var(--color-accent)] px-6 py-3 text-[var(--color-bg-base)] transition-colors duration-[var(--ku-dur-hover)] hover:bg-[var(--color-accent-hover)] focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-accent)]"
          >
            Start 21-day trial
          </Link>
        </div>
